...
foo = cylinder(7,servo.height+2*servo.wingL+1).rot(y=90).move(x=-servo.wingL/2-.1,y=2.4,z=thk).resize([0,44,0]).debug()
...
scene = bar() + bar().move(x=servo.height+servo.wingL) + _3rdAxis -foo #+_4thAxis - foo
